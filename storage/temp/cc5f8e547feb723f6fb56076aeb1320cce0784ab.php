...
$("#formadd").validate({
    submitHandler: function(form) {
        $.ajax({
			method: "POST",
            url: "<?php echo e(url('savelocation')); ?>",
...
$("#formedit").validate({
    submitHandler: function(form) {
        $.ajax({
			method: "POST",
            url: "<?php echo e(url('updatelocation')); ?>",
...
$("#formdelete").validate({
    submitHandler: function(form) {
        $.ajax({
			method: "POST",
            url: "<?php echo e(url('deletelocation')); ?>",
...
$('#edit').on('show.bs.modal', function(e) {
	...
	$.ajax({
		type: "POST",
		url: "<?php echo e(url('locationbyid')); ?>",
		data: {id:id},
		dataType: "JSON",
		success: function(data) {
			$("#editid").val(id);
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\massets\massets\core\resources\views/location/index.blade.php ENDPATH**/ ?>