    ...
    <div class="content p-4">
        <div class="row pt-3">
            ...
            <div class="col-md-4 text-md-right">
                                  <a target="_blank" href="<?php echo e(url('assetlist/generatelabel', $id)); ?>" id="btndetail" class="btn btn-sm btn-fill btn-primary"><i
                                        class="ti-info"></i> <?php echo trans('lang.generatelabel');?></a>
                                <a href="<?php echo e(url('assetlist')); ?>" id="btndetail"  class="btn btn-sm btn-fill btn-warning"><i
...
"use strict";
    ...
    $('#datamaintenance').DataTable({
        ajax: {
        url: "<?php echo e(url('maintenanceassetsbyid')); ?>",
        type: "post",
        data: function (d) {
              d.assetid = id;
            },
    ...
    $('#datacomponent').DataTable({
        ajax: {
        url: "<?php echo e(url('componentassetbyid')); ?>",
        type: "post",
        data: function (d) {
              d.assetid = id;
            }
    ...
    $('#datahistory').DataTable({
        ajax: {
        url: "<?php echo e(url('historyassetbyid')); ?>",
        type: "post",
        data: function (d) {
              d.assetid = id;
            }
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\massets\massets\core\resources\views/asset/detail.blade.php ENDPATH**/ ?>