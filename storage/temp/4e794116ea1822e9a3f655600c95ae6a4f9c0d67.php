    ...
    <div class="content p-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body ">
                    <div id="checkoutsuccess" style="display:none" class="alert alert-success"><?php echo trans('lang.data_checkout_succeess');?></div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="#" id="formadd" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div  style="display:none" class="messageexist alert alert-success"><?php echo trans('lang.tag_exist');?></div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6" style="margin-bottom:0px;">
								...
								<div class="input-group" style="margin-bottom:0px;">
									<span class="input-group-addon setcurrency" id="currency" style="border: 1px solid #cecece;"></span>                                      
                        ...
                        <div class="form-row">
                            ...
                            <label for="warranty" class="control-label"><?php echo trans('lang.warranty');?></label> 
								<div class="input-group" style="margin-bottom:0px;">                                    
                                    ...
                                    <span class="input-group-addon" id="warrantyyear" style="border: 1px solid #cecece;"><?php echo trans('lang.month');?></span>
                                </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6" style="margin-bottom:0px;">
								<label for="cost" class="control-label"><?php echo trans('lang.cost');?></label> 
								<div class="input-group" style="margin-bottom:0px;">
									<span class="input-group-addon setcurrency" id="editcurrency" style="border: 1px solid #cecece;"></span>                                      
                            ...
                            <div class="form-group col-md-6" style="margin-bottom:0px;">
                                    ...
                                    <span class="input-group-addon" id="editdate" style="border: 1px solid #cecece;"><i class="fa fa-calendar"></i></span>      
                                </div>
                                <label class="error" for="purchasedate"></label>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <label for="warranty" class="control-label"><?php echo trans('lang.warranty');?></label> 
								<div class="input-group" style="margin-bottom:0px;">                                    
                                    ...
                                    <span class="input-group-addon" id="editwarrantyyear" style="border: 1px solid #cecece;"><?php echo trans('lang.month');?></span>
                                </div>
                                <label class="error" for="warranty"></label>
                            </div>
                            <div class="form-group col-md-6" style="margin-bottom:0px;">
...
$.ajax({
        type: "GET",
		url: "<?php echo e(url('listemployees')); ?>",
		dataType: "JSON",
		success: function(html) {
            var objs = html.message;
            jQuery.each(objs, function (index, record) {
...
$.ajax({
        type: "GET",
		url: "<?php echo e(url('listlocation')); ?>",
		dataType: "JSON",
		success: function(html) {
            var objs = html.message;
            jQuery.each(objs, function (index, record) {
...
$.ajax({
        type: "GET",
		url: "<?php echo e(url('asset/generateproductcode')); ?>",
		dataType: "JSON",
		success: function(html) {
            var objs = html.message;
...
$("#formedit").validate({
    ...
    submitHandler: function(form) {
        ...
        $.ajax({
			type: "POST",
            url: "<?php echo e(url('updateasset')); ?>",
            data: form,
			contentType: 'multipart/form-data',
			processData: false,
            contentType: false,
...
$("#formdelete").validate({
    submitHandler: function(form) {
        $.ajax({
			method: "POST",
            url: "<?php echo e(url('deleteasset')); ?>",
...
$("#formcheckout").validate({
    submitHandler: function(form) {
        $.ajax({
			method: "POST",
            url: "<?php echo e(url('savecheckout')); ?>",
...
$("#formcheckin").validate({
    submitHandler: function(form) {
        $.ajax({
            method: "POST",
            url: "<?php echo e(url('savecheckin')); ?>",
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\massets\massets\resources\views/asset/index.blade.php ENDPATH**/ ?>