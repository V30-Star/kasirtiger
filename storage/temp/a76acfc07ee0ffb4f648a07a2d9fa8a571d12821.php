        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <form action="#" id="formcheckout" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="modal-body">
                         <div id="checkoutfailed" style="display:none" class="alert alert-success"><?php echo trans('lang.data_checkout_failed_quantity');?></div>
                        <div class="form-row">
    ...
    <div class="modal fade" id="delete" role="dialog">
        ...
        <div class="modal-content">
            <form action="#" id="formdelete">
                ...
                <div class="modal-body">
                <div  style="display:none" class="messageexist alert alert-success"><?php echo trans('lang.errordeletecomponent');?></div>
...
$("#formadd").validate({
    ...
    submitHandler: function(form) {
        ...
        $.ajax({
			type: "POST",
            url: "<?php echo e(url('savecomponent')); ?>",
            data: form,
...
$("#formedit").validate({
    ...
    submitHandler: function(form) {
        ...
        $.ajax({
			type: "POST",
            url: "<?php echo e(url('updatecomponent')); ?>",
            data: form,
			contentType: 'multipart/form-data',
			processData: false,
            contentType: false,
...
$("#formdelete").validate({
    submitHandler: function(form) {
        $.ajax({
			method: "POST",
            url: "<?php echo e(url('deletecomponent')); ?>",
...
$("#formcheckout").validate({
    ...
    submitHandler: function(form) {
        $.ajax({
            method: "POST",
            url: "<?php echo e(url('savecheckoutcomponent')); ?>",
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\massets\massets\resources\views/component/index.blade.php ENDPATH**/ ?>