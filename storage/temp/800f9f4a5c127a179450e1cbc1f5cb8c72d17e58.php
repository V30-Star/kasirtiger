...
"use strict";  
    $('#data').DataTable({
        ajax: "<?php echo e(url('department')); ?>",
        columns: [{
            data: 'id',
                orderable: false,
                searchable: false,
...
$("#formadd").validate({
    submitHandler: function(form) {
        $.ajax({
			method: "POST",
            url: "<?php echo e(url('savedepartment')); ?>",
...
$("#formedit").validate({
    submitHandler: function(form) {
        $.ajax({
			method: "POST",
            url: "<?php echo e(url('updatedepartment')); ?>",
...
$("#formdelete").validate({
    submitHandler: function(form) {
        $.ajax({
			method: "POST",
            url: "<?php echo e(url('deletedepartment')); ?>",
...
$('#edit').on('show.bs.modal', function(e) {
	...
	$.ajax({
		type: "POST",
		url: "<?php echo e(url('departmentbyid')); ?>",
		data: {id:id},
		dataType: "JSON",
		success: function(data) {
			$("#editid").val(id);
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\massets\massets\core\resources\views/department/index.blade.php ENDPATH**/ ?>