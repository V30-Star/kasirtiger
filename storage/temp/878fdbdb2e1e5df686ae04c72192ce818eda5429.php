...
$.ajax({
    ...
    var tabledata = $('#data').DataTable({
        bFilter : false,
        ajax: {
                url : "<?php echo e(url('getdatabylocationreport')); ?>",
                data: function (d) {
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\massets\massets\core\resources\views/reports/bylocation.blade.php ENDPATH**/ ?>