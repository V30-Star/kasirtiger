...
$(document).ready(function() {
    ...
    var tabledata = $('#data').DataTable({
        ...
        bFilter : false,
        ajax: {
                url : "<?php echo e(url('getdatabysupplierreport')); ?>",
                data: function (d) {
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\massets\massets\resources\views/reports/bysupplier.blade.php ENDPATH**/ ?>