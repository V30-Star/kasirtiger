...
$.ajax({
        type: "GET",
		url: "<?php echo e(url('listdepartment')); ?>",
		dataType: "JSON",
...
$("#formadd").validate({
    submitHandler: function(form) {
        $.ajax({
			method: "POST",
            url: "<?php echo e(url('saveemployees')); ?>",
...
$("#formedit").validate({
    submitHandler: function(form) {
        $.ajax({
			method: "POST",
            url: "<?php echo e(url('updateemployees')); ?>",
...
$("#formdelete").validate({
    submitHandler: function(form) {
        $.ajax({
			method: "POST",
            url: "<?php echo e(url('deleteemployees')); ?>",
...
$('#edit').on('show.bs.modal', function(e) {
	...
	$.ajax({
		type: "POST",
		url: "<?php echo e(url('employeesbyid')); ?>",
		data: {id:id},
		dataType: "JSON",
		success: function(data) {
			$("#editid").val(id);
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\massets\massets\core\resources\views/employee/index.blade.php ENDPATH**/ ?>