                                ...
                                <div class="card-body text-center">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 pl-4">
                                            <img width="45" class="icon-loading text-left" src="<?php echo asset('images/icon-loading.gif'); ?>" />
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div id="messageapprove" style="display:none" class="alert alert-success">
                                        <?php echo trans('lang.data_approve'); ?></div>
                ...
                var totalvisitors = new Chart(ctotalvisitors, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            data: [data.ijan, data.ifeb, data.imar, data.iapr, data.imay, data
                                .ijun,
                                data.ijul, data.iags, data.isep, data.iokt, data.inov, data
                                .ides
                            ],
