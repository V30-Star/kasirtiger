                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="fullname" type="text" id="fullname" class=" form-control" required
                                    placeholder="<?php echo trans('lang.fullname'); ?>" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="city" type="text" id="city" class=" form-control" required
                                    placeholder="<?php echo trans('lang.city'); ?>" />
                            </div>
                            <div class="form-group">
                ...
                <div class="modal-content">
                    <form action="#" id="formedit">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label><?php echo trans('lang.fullname'); ?></label>
                                <input name="fullname" type="text" id="editfullname" class=" form-control" required
                                    placeholder="<?php echo trans('lang.fullname'); ?>" />
                            </div>
                            <div class="form-group">
                                <label><?php echo trans('lang.email'); ?></label>
                                <input name="email" type="email" id="editemail" class=" form-control" required
                                    placeholder="<?php echo trans('lang.email'); ?>" />
                            </div>
                            <div class="form-group">
                                <label><?php echo trans('lang.phone'); ?></label>
                                <input name="phone" type="text" id="editphone" class=" form-control" required
                                    placeholder="<?php echo trans('lang.phone'); ?>" />
                            </div>
                            <div class="form-group">
                                <label><?php echo trans('lang.status'); ?></label>
                            ...
                            <div class="form-group">
                                <label><?php echo trans('lang.city'); ?></label>
                                <input name="city" type="text" id="editcity" class=" form-control" required
                                    placeholder="<?php echo trans('lang.city'); ?>" />
                            </div>
                            <div class="form-group">
                                <label><?php echo trans('lang.password'); ?></label>
