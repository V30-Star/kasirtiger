                            ...
                            <form action="" method="GET" id="form">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2" style="padding-top:33px;">
                                        <button type="submit" class="form-control btn btn-sm btn-fill btn-info"><i
                                                class="fa fa-search"></i> <?php echo trans('lang.search'); ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row, meta) {
                                var baseUrl =
                                    'https://storage.googleapis.com/storage-biasset/dev/files/';

                                // Jika data adalah null atau undefined, atau bukan string, gunakan 'default.jpg'
                                if (!data || typeof data !== 'string') {
                                    data = 'default.jpg';
                                } else if (data.startsWith(baseUrl)) {
                                    data = data.replace(baseUrl,
                                        ''); // Hapus baseUrl dari data jika ada
                                }

                                var imageUrl = baseUrl + data;

                                return '<img src="' + imageUrl +
                                    '" alt="Component Picture" style="width:90px">';
                            }
                        },
                        {
                            data: 'assettag',
