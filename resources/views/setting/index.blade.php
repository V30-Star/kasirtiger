                            ...
                            <form action="#" id="form">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input name="phonenumber" type="text" id="phone" class="form-control"
                                            required placeholder="<?php echo trans('lang.phone'); ?>" />
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input name="currency" type="text" id="currency" class="form-control"
                                            required placeholder="<?php echo trans('lang.currency'); ?>" />
                                    </div>

                                    <div class="col-md-6">
                                        <label><?php echo trans('lang.address'); ?></label>
                                        <textarea class="form-control" name="address" id="address" placeholder="<?php echo trans('lang.address'); ?>"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
